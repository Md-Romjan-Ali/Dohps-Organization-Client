...
import { BiChevronDown, BiChevronsDown, BiHelpCircle } from 'react-icons/bi';
interface Faq {
    answer: string,
    question: string
}
export default function FAQSection() {
    ...
    return (
        <section id='faq' className="bg-white py-16 px-4 sm:px-6 lg:px-8 font-sans">
            <div className="max-w-7xl mx-auto">

                {/* Header Block */}
                <div className="text-center mb-12">
                    <div className="flex justify-center text-blue-600 text-3xl mb-3">
                        <BiHelpCircle />
                    </div>
